...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post physicians_url, params: { physician: { first_name: @physician.first_name, last_name: @physician.last_name, postal_code: @physician.postal_code, specialty: @physician.specialty } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { first_name: @physician.first_name, last_name: @physician.last_name, postal_code: @physician.postal_code, specialty: @physician.specialty } }
